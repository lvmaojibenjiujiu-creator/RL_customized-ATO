...
class PPOConfig:
    ...
    long_design_dtp_blend: float = 0.0
    long_design_blend_start: float = 3.0
    long_design_blend_width: float = 4.0
    revealed_requirement_scale: float = 1.0
    high_bom_cv_requirement_scale: float = 1.0
    high_bom_cv_start: float = 0.4
    high_bom_cv_width: float = 0.1
